...
set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports {hdmi_out_cec}]
set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVCMOS33} [get_ports {hdmi_out_ddc_sda_io}]
set_property -dict {PACKAGE_PIN B9 IOSTANDARD LVCMOS33} [get_ports {hdmi_out__ddc_scl_io}]
