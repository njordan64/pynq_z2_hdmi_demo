...
//Date        : Fri Mar 21 23:37:46 2025
//Host        : gtr running 64-bit Ubuntu 24.10
//Command     : generate_target simple_hdmi.bd
//Design      : simple_hdmi
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "simple_hdmi,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=simple_hdmi,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "simple_hdmi.hwdef" *) 
module simple_hdmi
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.HDMI_OUT_CLK_N CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.HDMI_OUT_CLK_N, CLK_DOMAIN simple_hdmi_hdmi_top_0_0_hdmi_out_clk_n, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output hdmi_out_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.HDMI_OUT_CLK_P CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.HDMI_OUT_CLK_P, CLK_DOMAIN simple_hdmi_hdmi_top_0_0_hdmi_out_clk_p, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output hdmi_out_clk_p;
  ...
  wire hdmi_top_0_clk_pixel;
  wire hdmi_top_0_vid_tready;
  ...
  simple_hdmi_axi_intc_0_0 axi_intc_0
       (.intr(axi_vdma_0_mm2s_introut),
        .irq(axi_intc_0_irq),
        .s_axi_aclk(hdmi_top_0_clk_pixel),
  ...
  simple_hdmi_axi_smc_0 axi_smc
       (.M00_AXI_araddr(axi_smc_M00_AXI_ARADDR),
        ...
        .aclk(hdmi_top_0_clk_pixel),
        .aresetn(rst_ps7_0_100M_peripheral_aresetn));
  simple_hdmi_axi_vdma_0_0 axi_vdma_0
       (.axi_resetn(rst_ps7_0_100M_peripheral_aresetn),
        .m_axi_mm2s_aclk(hdmi_top_0_clk_pixel),
        ...
        .m_axis_mm2s_aclk(hdmi_top_0_clk_pixel),
        .m_axis_mm2s_tdata(axi_vdma_0_m_axis_mm2s_tdata),
        .m_axis_mm2s_tkeep(axi_vdma_0_m_axis_mm2s_tkeep),
        .m_axis_mm2s_tlast(axi_vdma_0_m_axis_mm2s_tlast),
        .m_axis_mm2s_tready(hdmi_top_0_vid_tready),
        .m_axis_mm2s_tuser(axi_vdma_0_m_axis_mm2s_tuser),
        .m_axis_mm2s_tvalid(axi_vdma_0_m_axis_mm2s_tvalid),
        .mm2s_frame_ptr_in({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .mm2s_introut(axi_vdma_0_mm2s_introut),
        .s_axi_lite_aclk(hdmi_top_0_clk_pixel),
  ...
  simple_hdmi_hdmi_top_0_0 hdmi_top_0
       (.CLK_100MHZ(processing_system7_0_FCLK_CLK0),
        .btns_4bits_tri_i(btns_4bits_tri_i),
        .clk_pixel(hdmi_top_0_clk_pixel),
        ...
        .vid_tdata(axi_vdma_0_m_axis_mm2s_tdata),
        .vid_tkeep(axi_vdma_0_m_axis_mm2s_tkeep),
        .vid_tlast(axi_vdma_0_m_axis_mm2s_tlast),
        .vid_tready(hdmi_top_0_vid_tready),
        .vid_tuser(axi_vdma_0_m_axis_mm2s_tuser),
        .vid_tvalid(axi_vdma_0_m_axis_mm2s_tvalid));
  simple_hdmi_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
        ...
        .MIO(FIXED_IO_mio),
        .M_AXI_GP0_ACLK(hdmi_top_0_clk_pixel),
        ...
        .S_AXI_HP0_ACLK(hdmi_top_0_clk_pixel),
  ...
  simple_hdmi_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
